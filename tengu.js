...
Tengu.modules.debug = function(tengu) {
    var _logCountArray = [],
        ...
        _lineNumber = function _lineNumber() {
            return _stackTrace()[1].getLineNumber();
        },
        _log = function _log() {
            var n = _lineNumber(),
                a = [],
...
Tengu.modules.math = function(tengu) {
    ...
    //Logrithm function with optional base
    tengu.logrithm = (function() {
        var log = Math.log;
